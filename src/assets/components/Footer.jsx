...
const Footer = () => {
    return (
        <div>
            <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-blue-800">
                <div class="mx-auto max-w-screen-xl text-center">
                    ...
                    <p class="my-6 text-gray-500 dark:text-gray-400">Brain Pay is a revolutionary platform designed to simplify and enhance digital transactions, offering secure and seamless payment solutions for businesses and individuals.</p>
                    ...
                    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" class="hover:underline">Brain Pay™</a>. All Rights Reserved.</span>
                </div>
            </footer>
        </div>
    )
